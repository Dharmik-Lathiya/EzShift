    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/50">
      ...
      >
        ...
        <div className="relative px-10 py-20 lg:py-32">
          ...
          >
            ...
            >
              <motion.button
                className="px-8 py-4 bg-white text-primary font-bold rounded-full shadow-lg hover:shadow-xl transition-all duration-300"
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <motion.button
              className="px-10 py-4 bg-white text-primary font-bold rounded-full shadow-lg hover:shadow-xl transition-all duration-300"
            ...
            <motion.button
              className="px-10 py-4 border-2 border-white text-white font-bold rounded-full hover:bg-white hover:text-primary transition-all duration-300"
              whileHover={{ scale: 1.05, y: -3 }}
              whileTap={{ scale: 0.95 }}
            >
              Schedule Survey
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            {[
              ...
              <motion.div
                key={index}
                className="text-center p-6 bg-gray-50 rounded-xl hover:bg-primary-light transition-colors duration-300 group"
                variants={itemVariants}
      ...
      {/* Footer CTA */}
      <motion.div 
        className="bg-gray-900 text-white px-10 py-16"
        initial={{ opacity: 0 }}
        whileInView={{ opacity: 1 }}
        transition={{ duration: 0.8 }}
        viewport={{ once: true }}
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.p 
            ...
            viewport={{ once: true }}
          >
            Join thousands of satisfied customers who chose EzShift for their relocation needs.
          </motion.p>
          <motion.button
            className="px-10 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold rounded-full shadow-lg hover:shadow-xl transition-all duration-300"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.2 }}
            viewport={{ once: true }}
          ...
          <motion.div 
            className="flex justify-center space-x-8 mt-12 pt-8 border-t border-gray-700"
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
            transition={{ delay: 0.3 }}
            viewport={{ once: true }}
